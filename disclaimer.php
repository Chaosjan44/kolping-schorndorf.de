...
$title = "Kolpingsfamilie Schorndorf e.V. - Disclaimer der Kolpingsfamilie Schorndorf e.V.";
$buffer = preg_replace('/(<title>)(.*?)(<\/title>)/i', '$1' . $title . '$3', $buffer);
echo $buffer;
?>
<div class="container py-3">
    <div style="min-height: 80vh;">
        <h1 class="display-3 text-center mb-3 text-kolping-orange">Disclaimer</h1>
        <h5 class="mb-1">Haftung für Inhalte</h5>
        <p class="mb-3">
        ...
        <h5 class="mb-1">Haftung für Links</h5>
        <p class="mb-3">
